      ...
      <main className="flex-1 flex items-center justify-center w-full text-white bg-gray-900 p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 w-full max-w-4xl">
          ...
          <div className="relative pb-12 flex flex-col sm:col-span-2 items-start min-h-[30px]">
            <h1 className="font-bold text-2xl sm:text-4xl">Bienvenido Agustín!</h1>
          </div>

          <div className="relative bg-gradient-to-br from-cyan-900 via-cyan-700 to-cyan-500 rounded-2xl shadow-lg p-6 flex flex-col items-start hover:scale-105 hover:contrast-125 transition min-h-[180px]">
